...
const Packages = ({ visiblePackageP, onClosePackageP }) => {
  ...
  return (
    ...
    <div id='modal' className='fixed inset-0 z-20 bg-black/30 backdrop-blur-sm flex justify-center items-center overflow-hidden' onClick={handleClosePackageP}>
      <div className='flex lg:flex-row md:flex-row flex-col justify-center items-center rounded-3xl bg-white lg:w-8/12 md:w-10/12 w-5/6 lg:h-4/5 md:h-4/6 h-full'>
        <div className=' h-full w-full flex justify-center items-center '>
          <div className='lg:w-4/5 w-4/5 border-2  rounded-xl border-[#04caa267] flex flex-col justify-center items-center lg:gap-2 gap-1 lg:py-8 py-4'>
